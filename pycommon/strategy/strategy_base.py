...
class StrategyBase(object, metaclass=ABCMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.strategy_mode = StrategyMode.INTRADAY  # <Type: Enum of type StrategyMode; This attribute will hold one of the following values - StrategyMode.INTRADAY or StrategyMode.DELIVERY. This value is passed to pycommon.algobulls.connection.backtest/papertest/realtrade methods.>
        self.number_of_lots = 1  # <Type: This attribute will hold one of the following values - StrategyMode.INTRADAY or StrategyMode.DELIVERY. This value is passed to pycommon.algobulls.connection.backtest/papertest/realtrade methods.>
