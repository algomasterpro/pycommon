...
from pycommon.broker.broker_connection_base import BrokerConnectionBase
from pycommon.constants import *
from pycommon.instrument.instrument import Instrument
from pycommon.utils.func import import_with_install
...
class BrokerConnectionZerodha(BrokerConnectionBase):
    ...
    def populate_constants(self):
        """
        Map pycommon constants to broker constants
        :return: None
        """
